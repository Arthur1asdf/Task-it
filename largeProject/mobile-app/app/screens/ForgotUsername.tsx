...
const ForgotUsername: React.FC = () => {
    ...
    // POST request to forgot username endpoint
    const handleForgotUsername = async (): Promise<void> => {
        try {
            const result = await forgotPassword(email);
            if (result.success) {
                Alert.alert("Check your email for username reset instructions.");
            } else {
        ...
        >
            <View style={styles.imageContainer}>
                ...
                <View style={styles.container}>
                    ...
                    <Text style={styles.description}>Enter your email address and we will send you instructions to reset your username.</Text>
                    ...
                    <View style={styles.buttonContainer}>
                        <TouchableOpacity onPress={() => { handleForgotUsername }} style={styles.resetButton}>
